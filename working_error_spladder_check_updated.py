...
# -*- coding: utf-8 -*-
"""
Created on Thu Dec 15 16:04:54 2022
...
with open('/Users/negar/Desktop/extable_full.txt', 'r') as input_file, open('/Users/negar/Desktop/output_PSI_2.txt', 'w') as output_file:
    ...
    for line in input_file:
        ...
        if columns[9].isnumeric() and columns[10].isnumeric() and columns[11].isdigit():
            ...
            # Write the original values from the input line, as well as the calculated expected value and error rate, to the output file
            output_file.write(line.strip() + ' ' + str(expected) + ' ' + str(error_rate) + '\n')
